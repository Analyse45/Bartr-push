...
import { ArrowLeft, MapPin, Star, Award, Calendar, Settings, Edit3 } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-6">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-1">Arjun Sharma</h2>
          ...
          <p className="text-gray-600 mb-4 max-w-sm mx-auto">
            Software developer who loves helping the community. Always ready to lend a hand! 🤝
          </p>
            ...
            {mockPosts.map((post) => (
              <div key={post.id} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge className={`${statusColors[post.status]} font-medium capitalize`}>
                    {post.status}
                  </Badge>
                </div>
          ...
          <TabsContent value="badges" className="mt-6">
            <div className="grid grid-cols-1 gap-4">
              {mockBadges.map((badge) => (
                <div key={badge.id} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            ...
            <div className="mt-6 p-5 bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl">
              <h3 className="font-semibold text-gray-900 mb-2">Next Badge Progress</h3>
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    <span className="text-gray-600">Super Helper (Help 10+ people)</span>
