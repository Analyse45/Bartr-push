...
const mockPosts: Post[] = [
  {
    ...
    description:
      "Need help moving furniture to my new apartment. Looking for 2-3 people who can help for 2 hours. Will provide snacks and drinks!",
  },
  {
    id: "2",
    ...
    description:
      "Lost golden retriever near Central Park. Goes by the name Max. Please contact if found. Reward offered.",
    isAnonymous: true,
  },
  {
    id: "3",
    ...
    timeAgo: "1 hour ago",
    description:
      "Professional house cleaning services available. 5 years experience. Reasonable rates. Contact for booking.",
  },
  {
    id: "4",
    ...
    timeAgo: "3 hours ago",
    description:
      "Looking for a freelance graphic designer for social media posts. Budget: ₹5000-8000 per month. Portfolio required.",
  },
];
